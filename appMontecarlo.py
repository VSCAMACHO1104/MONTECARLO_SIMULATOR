...
st.set_page_config(
    ...
    layout="centered", menu_items={
            ...
            Paso #3: Inserta las cantidades de pedido a evaluar.
            Paso #4: Inserta la cantidad de simulaciones deseada por cada cantidad de pedido a evaluar. 
            """
    }
)
...
# App title
st.title(":gray[Simulación Monte Carlo - Cantidad de Pedido óptimo]")
